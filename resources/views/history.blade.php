      ...
      <div class="row">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <table id="agenttableMessage" class="table">
                    <thead>
                      <tr>
                        <th>ID</th>
                        <th>Username</th>
                    ...
                    <tbody>
                      @foreach ($messages as $message)
                        ...
                        @if ( ($message->allowcallback == 'agent' || $message->allowcallback == 'agent/closer') ||   $message->status == 'RoughCall' || $message->prevStatus == 'Dropped')
                        ...
                        @elseif(($message->status == 'CallBack' &&  ($message->callBackType == 'Agent/Closer' ||  $message->callBackType == 'Agent')) || $message->callBackType == 'Dropped')
                          <td>
                              <div class="form-group">
